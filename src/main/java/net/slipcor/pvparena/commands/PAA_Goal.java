...
public class PAA_Goal extends AbstractArenaCommand {
    ...
    public void commit(final Arena arena, final CommandSender sender, final String[] args) {
        ...
        final ArenaGoal goal = PVPArena.getInstance().getAgm().getGoalByName(args[0].toLowerCase());

        if (goal == null) {
            arena.msg(sender, Language.parse(arena, MSG.ERROR_GOAL_NOTFOUND, args[0], StringParser.joinSet(PVPArena.getInstance().getAgm().getAllGoalNames(), " ")));
